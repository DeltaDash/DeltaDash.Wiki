...
This privacy notice for Delta Dash ( " **Company** ," "**we**," "**us**," or "**our**" ), describes how and why we might collect, store, use, and/or share ( "**process**" ) your information when you use our services ( "**Services**" ), such as when you:

- Visit our website at [https://deltada.sh](https://deltada.sh), or any website of ours that links to this privacy notice

- Engage with us in other related ways, including any sales, marketing, or events
- Use our Game available at [https://deltada.sh](https://deltada.sh) and create an account

**Questions or concerns?** Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at [contact@deltada.sh](mailto:contact@deltada.sh).
...
**What personal information do we process?** When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Delta Dash and the Services, the choices you make, and the products and features you use. Click [here](#personalinfo) to learn more.
...
Want to learn more about what Delta Dash does with any information we collect? Click [here](#toc) to review the notice in full.
...
- **IP adresses** **.** We may process IP addresses used to communicate with Delta Dash for Security concerns about multiple account and moderation purposes.

- **Hardware IDs** **.** We may process Hardware IDs (We can't find your machine using your Hardware ID or know anything inside of your machine, Hardware ID is just the unique signature of your computer) for Security concerns about multiple accounts and moderation purposes

- **Email adress** **.** We store and use emails for you to Restore your account, use password recovery, or for us to contact you...
...
If you have questions or comments about your privacy rights, you may email us at contact@deltada.sh.
...
You may contact us by email at [contact@deltada.sh](mailto:contact@deltada.sh), or by referring to the contact details at the bottom of this document.
...
Delta Dash has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Delta Dash will not sell personal information in the future belonging to website visitors, users, and other consumers.
...
To exercise these rights, you can contact us by email at contact@deltada.sh, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.
...
If you have questions or comments about this notice, you may email us at [contact@deltada.sh](mailto:contact@deltada.sh)

### 13\. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?

You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us with the mail you used to register your account.
